...
export const aboutData: AboutData = {
  paragraphs: [
    ...
    "When I'm not coding, you'll find me discovering new music, scrolling through the depths of the internet, or having deep philosophical conversations with my fish (just kidding... mostly)."
  ],
  stats: [
    {
